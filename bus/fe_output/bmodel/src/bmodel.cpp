...
#endif
    printf("load worker\n");
    set_bits_32 = ((packet_info->job_id * 4) + packet_info->worker_count); 
    index->set_value_32(set_bits_32, 31, 0);
#ifndef NO_CONSOLE_OUTPUT
    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
        bmi_log->normal("BM_TRACE: index->value_32: 0x%s;  line: %d", index->value_32.to_string(SC_HEX_US, false).c_str(), __LINE__);
...
#endif
        egress_pkt->l2_hdr->l2->macda = register_ps_worker_smac->value0;
    } else {
#ifndef NO_CONSOLE_OUTPUT
        if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
            bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
            egress_pkt->l2_hdr->l2->macda = register_ps_worker_smac->value1;
        } else {
#ifndef NO_CONSOLE_OUTPUT
            if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
                bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
                egress_pkt->l2_hdr->l2->macda = register_ps_worker_smac->value2;
            } else {
#ifndef NO_CONSOLE_OUTPUT
                if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
                    bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
                    egress_pkt->l2_hdr->l2->macda = register_ps_worker_smac->value3;
                } else {
#ifndef NO_CONSOLE_OUTPUT
                    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
                        bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
        egress_pkt->l3_hdr->ipv4->dip = register_ps_worker_sip->value0;
    } else {
#ifndef NO_CONSOLE_OUTPUT
        if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
            bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
            egress_pkt->l3_hdr->ipv4->dip = register_ps_worker_sip->value1;
        } else {
#ifndef NO_CONSOLE_OUTPUT
            if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
                bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
                egress_pkt->l3_hdr->ipv4->dip = register_ps_worker_sip->value2;
            } else {
#ifndef NO_CONSOLE_OUTPUT
                if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
                    bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
                    egress_pkt->l3_hdr->ipv4->dip = register_ps_worker_sip->value3;
                } else {
#ifndef NO_CONSOLE_OUTPUT
                    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
                        bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
        egress_pkt->l4_hdr->udp->dport = register_ps_worker_sport->value0;
    } else {
#ifndef NO_CONSOLE_OUTPUT
        if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
            bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
            egress_pkt->l4_hdr->udp->dport = register_ps_worker_sport->value1;
        } else {
#ifndef NO_CONSOLE_OUTPUT
            if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
                bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
                egress_pkt->l4_hdr->udp->dport = register_ps_worker_sport->value2;
            } else {
#ifndef NO_CONSOLE_OUTPUT
                if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
                    bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
#endif
                    egress_pkt->l4_hdr->udp->dport = register_ps_worker_sport->value3;
                } else {
#ifndef NO_CONSOLE_OUTPUT
                    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
                        bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
...
void _BModel::worker_count_sub(void) {
    _32bits set_bits_32;
    _16bits set_bits_16;
...
void _BModel::worker_count_set(void) {
    _32bits set_bits_32;
    _16bits set_bits_16;
...
#endif
        set_bits_16 = packet_info->max_worker; 
        register_ps_worker_count->set_value0(set_bits_16, -1, 0);
    } else {
#ifndef NO_CONSOLE_OUTPUT
        if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
#endif
        set_bits_16 = register_ps_exp->value0; 
        packet_info->set_exp(set_bits_16, 15, 0);
    } else {
#ifndef NO_CONSOLE_OUTPUT
        if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
#endif
            set_bits_16 = register_ps_exp->value1; 
            packet_info->set_exp(set_bits_16, 15, 0);
        } else {
#ifndef NO_CONSOLE_OUTPUT
            if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
#endif
                set_bits_16 = register_ps_exp->value2; 
                packet_info->set_exp(set_bits_16, 15, 0);
            } else {
#ifndef NO_CONSOLE_OUTPUT
                if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
#endif
                    set_bits_16 = register_ps_exp->value3; 
                    packet_info->set_exp(set_bits_16, 15, 0);
                } else {
#ifndef NO_CONSOLE_OUTPUT
                    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
void _BModel::save_first_exp(void) {
    _32bits set_bits_32;
    _16bits set_bits_16;
...
#ifndef NO_CONSOLE_OUTPUT
    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
        bmi_log->normal("BM_TRACE: ingress_pkt->l4_hdr->udp->exp: 0x%s;  line: %d", ingress_pkt->l4_hdr->udp->exp.to_string(SC_HEX_US, false).c_str(), __LINE__);
        bmi_log->normal("BM_TRACE: tmp->value_16: 0x%s;  line: %d", tmp->value_16.to_string(SC_HEX_US, false).c_str(), __LINE__);
    }
#endif
...
void _BModel::read_bias_exp(void) {
    _32bits set_bits_32;
    _16bits set_bits_16;
...
#endif
        set_bits_16 = register_ps_bias_exp->value0; 
        packet_info->set_bias_exp(set_bits_16, 15, 0);
    } else {
#ifndef NO_CONSOLE_OUTPUT
        if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
#endif
            set_bits_16 = register_ps_bias_exp->value1; 
            packet_info->set_bias_exp(set_bits_16, 15, 0);
        } else {
#ifndef NO_CONSOLE_OUTPUT
            if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
#endif
                set_bits_16 = register_ps_bias_exp->value2; 
                packet_info->set_bias_exp(set_bits_16, 15, 0);
            } else {
#ifndef NO_CONSOLE_OUTPUT
                if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
#endif
                    set_bits_16 = register_ps_bias_exp->value3; 
                    packet_info->set_bias_exp(set_bits_16, 15, 0);
                } else {
#ifndef NO_CONSOLE_OUTPUT
                    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
void _BModel::save_first_bias_exp(void) {
    _32bits set_bits_32;
    _16bits set_bits_16;
...
#endif
    printf("save first bias exponent\n");
    set_bits_32 = ((packet_info->job_id * 4) + (packet_info->sequence % 4)); 
    index->set_value_32(set_bits_32, 31, 0);
#ifndef NO_CONSOLE_OUTPUT
    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
void _BModel::save_bias_exp(void) {
    _32bits set_bits_32;
    _16bits set_bits_16;
...
#ifndef NO_CONSOLE_OUTPUT
    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
        bmi_log->normal("BM_TRACE: ingress_pkt->l4_hdr->udp->bias_exp: 0x%s;  line: %d", ingress_pkt->l4_hdr->udp->bias_exp.to_string(SC_HEX_US, false).c_str(), __LINE__);
        bmi_log->normal("BM_TRACE: tmp->value_16: 0x%s;  line: %d", tmp->value_16.to_string(SC_HEX_US, false).c_str(), __LINE__);
    }
#endif
...
void _BModel::save_first_bias(void) {
    _32bits set_bits_32;
    _16bits set_bits_16;
...
void _BModel::save_bias(void) {
...
#endif
        set_bits_16 = register_ps_bias->value0; 
        tmp->set_value_16(set_bits_16, 15, 0);
    } else {
#ifndef NO_CONSOLE_OUTPUT
        if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
#endif
            set_bits_16 = register_ps_bias->value1; 
            tmp->set_value_16(set_bits_16, 15, 0);
        } else {
#ifndef NO_CONSOLE_OUTPUT
            if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
#endif
                set_bits_16 = register_ps_bias->value2; 
                tmp->set_value_16(set_bits_16, 15, 0);
            } else {
#ifndef NO_CONSOLE_OUTPUT
                if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
...
#endif
                    set_bits_16 = register_ps_bias->value3; 
                    tmp->set_value_16(set_bits_16, 15, 0);
                } else {
#ifndef NO_CONSOLE_OUTPUT
                    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
    ...
    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
        bmi_log->normal("BM_TRACE: ingress_pkt->l4_hdr->udp->bias_exp: 0x%s;  line: %d", ingress_pkt->l4_hdr->udp->bias_exp.to_string(SC_HEX_US, false).c_str(), __LINE__);
        bmi_log->normal("BM_TRACE: packet_info->bias_exp: 0x%s;  line: %d", packet_info->bias_exp.to_string(SC_HEX_US, false).c_str(), __LINE__);
    }
#endif
    if ((packet_info->bias_exp >= ingress_pkt->l4_hdr->udp->bias_exp)) {
        ...
        set_bits_16 = (packet_info->bias_exp - ingress_pkt->l4_hdr->udp->bias_exp); 
        tmp->set_shift(set_bits_16, 15, 0);
    } else {
#ifndef NO_CONSOLE_OUTPUT
        if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
            bmi_log->normal("BM_TRACE: %s()  line: %d", __FUNCTION__, __LINE__);
        ...
        set_bits_16 = (ingress_pkt->l4_hdr->udp->bias_exp - packet_info->bias_exp); 
        tmp->set_shift(set_bits_16, 15, 0);
    }
#ifndef NO_CONSOLE_OUTPUT
    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
        bmi_log->normal("BM_TRACE: tmp->shift: 0x%s;  line: %d", tmp->shift.to_string(SC_HEX_US, false).c_str(), __LINE__);
    }
#endif
    if ((0 == tmp->shift)) {
#ifndef NO_CONSOLE_OUTPUT
        ...
        set_bits_16 = (tmp->value_16 + ingress_pkt->l4_hdr->udp->bias); 
        tmp->set_value_16(set_bits_16, 15, 0);
    } else {
#ifndef NO_CONSOLE_OUTPUT
        if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
        ...
        if ((packet_info->bias_exp >= ingress_pkt->l4_hdr->udp->bias_exp)) {
            ...
            set_bits_16 = (tmp->value_16 >> (tmp->shift + ingress_pkt->l4_hdr->udp->bias)); 
            tmp->set_value_16(set_bits_16, 15, 0);
        } else {
#ifndef NO_CONSOLE_OUTPUT
            if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
            ...
            set_bits_16 = ((tmp->value_16 + ingress_pkt->l4_hdr->udp->bias) >> tmp->shift); 
            tmp->set_value_16(set_bits_16, 15, 0);
        }
    }
#ifndef NO_CONSOLE_OUTPUT
...
void _BModel::save_first_value(void) {
    _32bits set_bits_32;
    ...
    if ((0x00 == index->value_32)) {
...
#endif
        if (ingress_pkt->payload->pss[0]->_PRESENT_CUR != 1) {
#ifndef NO_CONSOLE_OUTPUT
            bmi_log->error("ERROR: %s() Header ingress_pkt->payload->pss[0] not present", __FUNCTION__);
#endif
        }
        set_bits_8192 = (register_ps_value->value00 + ingress_pkt->payload->pss[0]->values); 
        register_ps_value->set_value00(set_bits_8192, -1, 0);
        if (ingress_pkt->payload->pss[1]->_PRESENT_CUR != 1) {
#ifndef NO_CONSOLE_OUTPUT
            bmi_log->error("ERROR: %s() Header ingress_pkt->payload->pss[1] not present", __FUNCTION__);
#endif
        }
        set_bits_8192 = (register_ps_value->value01 + ingress_pkt->payload->pss[1]->values); 
        ...
        if ((0x01 == index->value_32)) {
            ...
            set_bits_8192 = (register_ps_value->value10 + ingress_pkt->payload->pss[0]->values); 
            ...
            set_bits_8192 = (register_ps_value->value11 + ingress_pkt->payload->pss[1]->values); 
            ...
            if ((0x02 == index->value_32)) {
                ...
                set_bits_8192 = (register_ps_value->value20 + ingress_pkt->payload->pss[0]->values); 
                ...
                set_bits_8192 = (register_ps_value->value21 + ingress_pkt->payload->pss[1]->values); 
                ...
                if ((0x03 == index->value_32)) {
                    ...
                    set_bits_8192 = (register_ps_value->value30 + ingress_pkt->payload->pss[0]->values); 
                    ...
                    set_bits_8192 = (register_ps_value->value31 + ingress_pkt->payload->pss[1]->values); 
...
#ifndef NO_CONSOLE_OUTPUT
                    if (bm_debug_lvl >= BM_DEBUG_LVL_TRACE) {
                        bmi_log->normal("BM_TRACE: packet_info->exp: 0x%s;  line: %d", packet_info->exp.to_string(SC_HEX_US, false).c_str(), __LINE__);
                    }
#endif
