 ...
 * All Rights Reserved.$
 * File:     bm_mgmt_if.h
 * Purpose:  Behavior Model management interface header
 *
...
#ifndef _BM_MGMT_IF_H_
#define _BM_MGMT_IF_H_
 ...
 */
extern int
bm_mgmt_read(int unit, bm_sid_t sid,
 ...
 */
extern int
bm_mgmt_write(int unit, bm_sid_t sid,
             bm_pt_dyn_info_t *dyn_info, void *ovrr_info,
             uint32_t *data);
 ...
 */
extern int
bm_mgmt_lt_entry(int unit, bm_sid_t sid, bm_pt_dyn_info_t *dyn_info);

#endif /* _BM_MGMT_IF_H_ */
