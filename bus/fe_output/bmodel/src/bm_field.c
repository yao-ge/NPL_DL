 ...
 * All Rights Reserved.$
 * File:     bm_field.c
 * Purpose:  Behavior Model field source
 *
 ...
 */
uint32_t *
bm_field_get(const uint32_t *entbuf, int sbit, int ebit, uint32_t *fbuf)
{
    int i, wp, bp, len;
 ...
 */
void
bm_field_set(uint32_t *entbuf, int sbit, int ebit, uint32_t *fbuf)
{
    uint32_t mask;
    int i, wp, bp, len;
